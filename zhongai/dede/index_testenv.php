...
//	<a href="'.$helpurl.'" style="color:blue;text-decoration:underline;">查看如何取消</a>';
//}
...
//	$safeMsg[] = '<font color="blue">强烈建议将data目录搬移到Web根目录以外；</font><a href="'.$helpurl.'" style="color:blue;text-decoration:underline;">查看如何搬迁</a>';
//}
?>
<?php
if(count($safeMsg) > 0)
