	...
	var addonDialog = function( editor, dialogType )
	{
		return {
			...
			onOk : function()
			{
				...
				var tempvar='<table width="450">\r    <tbody>\r        <tr>\r            <td width="20" height="30"><a href="'+addonUrl+'"><img border="0" align="middle" src="/plus/img/addon.gif" alt="" /></a></td>\r            <td><a href="'+addonUrl+'"><u>'+addonTitle+'</u></a></td>\r        </tr>\r    </tbody>\r</table>';
