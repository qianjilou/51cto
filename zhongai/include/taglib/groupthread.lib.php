...
{dede:groupthread gid='0' orderby='dateline' orderway='desc' row='12' titlelen='30'}
 <li>
  <a href='[field:groupurl/]'>[[field:groupname function="cn_substr(@me,10)"/]]</a>
  <a href="[field:url/]" title="[field:subject/]">[field:subject/]</a>([field:lastpost function="GetDateMk('@me')"/])
 </li>
{/dede:groupthread} 
</demo>
<attributes>
